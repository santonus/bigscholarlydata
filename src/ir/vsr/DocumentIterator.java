...
public class DocumentIterator {
    ...
    /** docType for Text files that understand domain specific glossary*/
    public static final short TYPE_DOMTEXT = 2;
	...
	case TYPE_HTML:
	    ...
	    break;
	case TYPE_DOMTEXT:
		doc = new SpecialFileDocument(files[position], stem);
		break;
	}
